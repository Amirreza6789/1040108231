...
bot = Bot("pydroid 3", auth="inclibmcilwisdoztrsuhxfwgsqwqnwa")
target = "g0BaeXS05bbcdf153cfb60c3b34ac75a"
			...
			if msg["type"]=="Text" and not msg.get("message_id") in answered:
				if not sleeped:
					if msg.get("text") == "روشن" and msg.get("author_object_guid") in admins :
						...
						bot.sendMessage(target, "از منم خرابه اینترنت ی کاری کرده زندگی ما ربات ها سخت تر بشه", message_id=msg.get("message_id"))
						...
						bot.sendMessage(target, "کص اگه شعر داشت کی.ر من گیتار میزد", message_id=msg.get("message_id"))
					...
					elif msg.get("text") == "فیلترت":
						bot.sendMessage(target, "همت کنی پشماشو بزنی", message_id=msg.get("message_id"))
